...
console.log('Adds to and removes data from arrays');
// adding new items
numberArray1.push(6);
...
const init = () => {
    ...
    let newLineItem = $("<li>Line item 1</li>");
    let anotherLineItem = $("<li>Line item 2</li>");
    ...
    newLineItem = $("<li>Line item 1</li>");
    anotherLineItem = $("<li>Line item 2</li>");
